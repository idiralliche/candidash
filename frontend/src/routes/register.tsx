...
function RegisterPage() {
  ...
  function onSubmit(values: RegisterFormValues) {
    // Orval attend { data: UserCreate }
    // Le type UserCreate exige 'confirm_password' comme défini dans le backend
    register({
      data: {
        email: values.email,
        ...
        confirm_password: values.confirmPassword, // <--- AJOUTÉ ICI pour satisfaire le type UserCreate
      }
    });
  }
